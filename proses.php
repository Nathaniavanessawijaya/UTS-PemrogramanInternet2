...
if (isset($_POST['submit_simpan_mkuliah'])) {
 ...
 $kodeprodi = $_POST['kodeprodi'];
 $model = new Model();
 $model->insert_mkuliah($kodemk, $namamk, $sks, $smt, $kodeprodi);
...
if (isset($_POST['submit_edit_mkuliah'])) {
 ...
 $kodeprodi = $_POST['kodeprodi'];
 $model = new Model();
 $model->update_mkuliah($kodemk, $namamk, $sks, $smt, $kodeprodi);
 header('location:mkuliah.php');
}
if (isset($_GET['mkuliah_id'])) {
 $kodemk = $_GET['mkuliah_id'];
 $model = new Model();
 $model->delete_mkuliah($kodemk);
 header('location:mkuliah.php');
}
//prodi
