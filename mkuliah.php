  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="mkuliah.php">Matakuliah</a>
        </li>
        <li class="nav-item">
...
<div class="container">
        ...
        <a href="create_mkuliah.php">Tambah Data</a>
        <br>
        <a href="print_mkuliah.php" target="_blank">Cetak Data</a>
        <br>
        <table border="1">
            <thead>
                <tr>
                ...
                if (!empty($result)) {
                    foreach ($result as $data) : ?>
                        <tr>
                            ...
                            <td>
                                <a name="edit" id="edit" href="edit_mkuliah.php?id=<?= $data->kodemk ?>">Edit</a>
                                <a name="hapus" id="hapus" href="proses.php?mkuliah_id=<?= $data->kodemk ?>">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach;
                } else { ?>
